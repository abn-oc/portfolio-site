export default function Landing() {
    ...
    <div className="min-h-screen flex flex-col mt-12 sm:mt-0">
      <h2 className="font-ebgaramond text-zinc-50 text-3xl sm:text-6xl mt-0 sm:mt-5">welcome to my site.</h2>
      <h1 className="font-semibold text-zinc-50 text-2xl sm:text-3xl mt-2">abdullah ihtasham</h1>
      <div className="flex flex-row gap-2 text-md text-zinc-300 mt-2">
        <a href="" className="hover:text-zinc-50 hover:underline">stats</a>
        <a href="" className="hover:text-zinc-50 hover:underline">projects</a>
        <a href="" className="hover:text-zinc-50 hover:underline">experience</a>
      </div>
